...
*/
/*2015년부터 ECMAScrpt(정식명칭): 클래스*/ 
class Arrow{
    //클래스 안에 선언된 변수는, 이 클래스 소속이 되므로 변수명 앞에 자기 자신것이라는 
    //대명사를 붙여야 하며, this라는 이미 정해진 변수를 쓴다.
    //소유권을 '주체'의 소유

    //ES 2015년에 발표된 js에 의해서, 클래스가 소유한 변수는 constructor()라는 생성자 함수에
    //넣어 놓아야 한다.
    
    //화살 생성
    //클래스안에 선언된 보요한 함수는 해당 사물의 동작방법을 결정짓는다 하여
    //메서드라고 한다.... method(방법)
    constructor(x, y){
        this.arrow;
        this.stepX = 10; //몇 픽셀씩 움질일지 결정하는 변수
